...
CREATE PROCEDURE Clinicas.EliminarPaciente
(@ID_Paciente int)
as 
...
GO
	...
	CREATE PROCEDURE Clinicas.IngresarLaboratorio
	(@id_Laboratorio int,
	@Descripcion varchar(255)
	)
	as
    insert into laboratorio
	values(@id_Laboratorio, @Descripcion)
	go

	CREATE PROCEDURE Clinicas.BorrarLaboratorio
	(@id_Laboratorio int)
	as 
	...
	CREATE PROCEDURE Clinicas.VerLaboratorio
	(@id_Laboratorio int)
	as 
	...
	CREATE PROCEDURE Clinicas.ActualizarLaboratorio
	(@id_Laboratorio int,
	@Descripcion varchar(255))
	as
	update Clinicas.laboratorio
	set Descripcion = @Descripcion
	where @id_Laboratorio=id_Laboratorio
	go
	...
	CREATE PROCEDURE Clinicas.BorrarCita
	(@id_Cita int)
	as 
	delete from cita
	...
	CREATE PROCEDURE Clinicas.VerCita
	(@id_Cita int)
	as 
	select * from cita
	where @id_Cita = id_Cita
	...
	CREATE PROCEDURE Clinicas.IngresarTpEstudio
	(@idTipo_Estudio int,
	@Nombre varchar(150),
	@precio decimal(18,0))
	as
	insert into tipoEstudio
	values (@idTipo_Estudio,@Nombre,@precio)
	go

	CREATE PROCEDURE Clinicas.BorrarTpEstudio
	(@idTipo_Estudio int)
	as 
	...
	CREATE PROCEDURE Clinicas.VerTpEstudio
	(@idTipo_Estudio int)
	as 
	select * from tipoEstudio
	where @idTipo_Estudio = IdTipo_Estudio
	go

	CREATE PROCEDURE Clinicas.ActualizarTpEstudio
	(@idTipo_Estudio int,
	@precio decimal(18,0))
	as
	update Clinicas.tipoEstudio
	set precio = @precio
	where @idTipo_Estudio=IdTipo_Estudio
	go
